...
def run_layout_engine():
    ...
    cb_w, cb_d, cb_h = 1.2, 0.4, 0.45
    create_box("Closet_Bench", (2.75, 0.0, cb_h/2), (cb_w, cb_d, cb_h), rotation=(0, 0, math.pi/2), material=mat_wood, collection=coll_zone3)
